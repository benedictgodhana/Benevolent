    ...
    public function store(Request $request)
{
    $rules = [
        ...
        'email' => [
            ...
            function ($attribute, $value, $fail) {
                if (!str_ends_with($value, '@strathmore.edu')) {
                    $fail('The ' . $attribute . ' must be a Strathmore email address.');
                }
            },
        ],
        ...
        'contractDuration' => [
            ...
            function ($attribute, $value, $fail) use ($request) {
                if ($request->input('employmentType') === 'Contract' && empty($value)) {
                    $fail('The ' . $attribute . ' field is required when employment type is Contract.');
                }
            },
        ],
    ...
    $userProfile = UserProfile::create([
        ...
        'contractDuration' => $request->employmentType === 'Contract' ? $request->contract_duration : null,
